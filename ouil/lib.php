	...
	if((displaysection!=0) ||(targetElement.id==markersection)){
		...
		echo " 
			...
			if(sectionID.indexOf('section-')!=-1){
				...
				if(main){
					main.process_single_sections (sectionID);
				}
			}
			";
		}
...
echo ' var openAllSection_gif= "'.$CFG->themewww .'/'.current_theme().'/images/open.jpg"; ';
echo ' var closeAllSection_gif= "'.$CFG->themewww .'/'.current_theme().'/images/close.jpg";';
...
echo "
	if(	main!=undefined){
		main.process_single_sections(0);
	} ";
}
	echo '
